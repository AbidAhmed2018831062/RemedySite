...
import style from '../asset/css/showallblogs.module.css';
import logout from '../asset/images/logout.png';
import ShowPosts from './Blogs';
...
function AllBlogs({posts})
{
    ...
    let category=["All","Neurologist", "Heart","Gastric","Pediatricians","Gyenocologist","Flu","Allergists","Psychiatrist","Ophthalmologist","Urologists","Other"];
